module Iichi
    ...
    # # REGISTER_PAGE
        ...
        # 色
        driver.execute_script("document.getElementById('" + "item_color_color_red" + "').click()")
        ...
        driver.find_element(:id => "item_ja_remark").send_keys("1つ1つ手作りをしているため、同じ作品でも微妙にホログラムやパーツの位置、グラデーションなどが異なります。一つ一つ、オンリーワンのピアスをお楽しみください¥n¥n同じデザインの別カラーや、こういったデザインが欲しいと言ったご希望にも可能な限り応えたいと思っていますので、お気軽にメッセージをお送りください◎")
